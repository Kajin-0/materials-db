...
// Ionization energies in eV. [First IE, Second IE, ...] - Added first where available.
...
window.periodicTableData = {
  ...
  "O": {
    ...
    ionization_energies: [13.6181]
  },
  "F": {
    number: 9, name: "Fluorine", mass: 18.998, category: "diatomic nonmetal halogen",
  ...
  "S": {
    ...
    ionization_energies: [10.3600]
  },
  "Cl": {
    number: 17, name: "Chlorine", mass: 35.45, category: "diatomic nonmetal halogen",
  ...
  "Se": {
    ...
    ionization_energies: [9.7524]
  },
  "Br": {
    number: 35, name: "Bromine", mass: 79.904, category: "diatomic nonmetal halogen",
  ...
  "Mo": {
    ...
    ionization_energies: [7.0924]
  },
  "Tc": {
    number: 43, name: "Technetium", mass: 98, category: "transition metal",
  ...
  "Te": {
    ...
    ionization_energies: [9.0096]
  },
  "I": {
    number: 53, name: "Iodine", mass: 126.90, category: "diatomic nonmetal halogen",
  ...
  "Ba": {
    ...
    ionization_energies: [5.2117]
  },
  "La": {
    number: 57, name: "Lanthanum", mass: 138.91, category: "lanthanide",
    group: null, period: 6, block: "f", density: 6.146, melt: 920, boil: 3464,
    heat: 0.195, conduct: 13.4, e_neg_pauling: 1.10, electron_configuration_semantic: "[Xe] 5d¹ 6s²", atomic_radius: 274,
    ionization_energies: [5.5769]
  },
  "Ce": {
  ...
  "Lu": {
    ...
    heat: 0.154, conduct: 16.4, e_neg_pauling: 1.27, electron_configuration_semantic: "[Xe] 4f¹⁴ 5d¹ 6s²", atomic_radius: 221,
    ionization_energies: [5.4259]
  },
  "Hf": {
  ...
  "Po": {
    ...
    ionization_energies: [8.417]
  },
  "At": {
    number: 85, name: "Astatine", mass: 210, category: "metalloid halogen",
    ...
    ionization_energies: [9.3] // Estimated
  },
  "Rn": {
  ...
  "Ac": {
    ...
    ionization_energies: [5.17] // Estimated
  },
  "Th": {
  ...
  "Pa": {
    ...
    ionization_energies: [5.89] // Estimated
  },
  "U": {
  ...
  "Lr": {
    ...
    heat: null, conduct: 10, e_neg_pauling: 1.3, electron_configuration_semantic: "[Rn] 5f¹⁴ 7s² 7p¹", atomic_radius: 246,
    ionization_energies: [4.9] // Estimated
  },
  "Rf": {
    ...
    ionization_energies: [6.0] // Estimated
  },
  "Db": {
    ...
    heat: null, conduct: null, e_neg_pauling: null, electron_configuration_semantic: "[Rn] 5f¹⁴ 6d³ 7s²", atomic_radius: null,
    ionization_energies: [6.8] // Estimated
  },
  "Sg": {
    ...
    heat: null, conduct: null, e_neg_pauling: null, electron_configuration_semantic: "[Rn] 5f¹⁴ 6d⁴ 7s²", atomic_radius: null,
    ionization_energies: [7.7] // Estimated
  },
  "Bh": {
  ...
  "Hs": {
    ...
    heat: null, conduct: null, e_neg_pauling: null, electron_configuration_semantic: "[Rn] 5f¹⁴ 6d⁶ 7s²", atomic_radius: null,
    ionization_energies: [7.9] // Estimated
  },
  "Mt": {
    ...
    heat: null, conduct: null, e_neg_pauling: null, electron_configuration_semantic: "[Rn] 5f¹⁴ 6d⁷ 7s²", atomic_radius: null,
    ionization_energies: [8.7] // Estimated
  },
  "Ds": {
    ...
    heat: null, conduct: null, e_neg_pauling: null, electron_configuration_semantic: "[Rn] 5f¹⁴ 6d⁸ 7s²", // Could be 6d⁹ 7s¹
     atomic_radius: null,
     ionization_energies: [9.7] // Estimated
  },
  "Rg": {
    ...
    heat: null, conduct: null, e_neg_pauling: null, electron_configuration_semantic: "[Rn] 5f¹⁴ 6d⁹ 7s²", // Could be 6d¹⁰ 7s¹
     atomic_radius: null,
     ionization_energies: [10.6] // Estimated
  },
  "Cn": {
    ...
    heat: null, conduct: null, e_neg_pauling: null, electron_configuration_semantic: "[Rn] 5f¹⁴ 6d¹⁰ 7s²", atomic_radius: null,
    ionization_energies: [11.7] // Estimated
  },
  "Nh": {
    ...
    ionization_energies: [7.306] // Estimated
  },
  "Fl": {
    ...
    heat: null, conduct: null, e_neg_pauling: null, electron_configuration_semantic: "[Rn] 5f¹⁴ 6d¹⁰ 7s² 7p²", atomic_radius: null,
    ionization_energies: [8.539] // Estimated
  },
  "Mc": {
    ...
    heat: null, conduct: null, e_neg_pauling: null, electron_configuration_semantic: "[Rn] 5f¹⁴ 6d¹⁰ 7s² 7p³", atomic_radius: null,
    ionization_energies: [5.6] // Estimated
  },
  "Lv": {
  ...
  "Og": {
    ...
    heat: null, conduct: null, e_neg_pauling: null, electron_configuration_semantic: "[Rn] 5f¹⁴ 6d¹⁰ 7s² 7p⁶", atomic_radius: null,
    ionization_energies: [8.6] // Estimated
  }
};
