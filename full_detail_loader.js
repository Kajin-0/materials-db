    ...
    function initializeSimplifiedThreeJsViewer(viewerElementId, controlsElementId, vizData, allMaterialDetails) {
        ...
        function createOrUpdateBallAndStickModel(atomData) {
            ...
            for (let i = 0; i < atomData.length; i++) {
             ...
             console.log(`[Three.js Simplified] Rebuilt model. Children: ${crystalModelGroup.children.length}`);
        }
        ...
        try {
            ...
            if (viewerContainer) viewerContainer.innerHTML = `<p class="error-message" style="padding:20px;">Failed init. Check console.</p>`;
